...
It is based on the Zanshin Python SDK available on [GitHub](https://github.com/tenchi-security/zanshin-sdk-python) and [PyPI](https://pypi.python.org/pypi/zanshinsdk/).
